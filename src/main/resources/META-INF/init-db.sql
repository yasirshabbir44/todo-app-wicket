...
INSERT INTO project(id, name,  createdat, updatedat, version) VALUES ('cd5cd458-294d-4ef9-99eb-0a15848433c6', 'Dubai Digital Park',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
 ...
 INSERT INTO task(id, title,description,priority,status,duedate, createdat,updatedat, version,person_id,project_id) VALUES ('0ca6271d-a96e-4864-9abc-11910c0de842', 'Security Camera Integration', ' Integrate the system with existing security measures, such as access control systems and surveillance cameras.','HIGH','COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP, 0,'cd5cd458-294d-4ef9-99eb-0a15841133c7','0ca6271d-a96e-4864-9abc-15980c0de842');
